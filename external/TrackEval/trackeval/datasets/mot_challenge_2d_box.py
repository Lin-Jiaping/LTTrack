...
class MotChallenge2DBox(_BaseDataset):
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if is_gt:
            data_keys += ["gt_crowd_ignore_regions", "gt_extras", "gt_visibility"]
        else:
        ...
        for t in range(num_timesteps):
            ...
            if time_key in read_data.keys():
                ...
                if is_gt:
                    ...
                    raw_data["gt_visibility"][t] = np.atleast_1d(time_data[:, -1])  # added by ljp
                else:
                ...
                if is_gt:
                    ...
                    raw_data["gt_extras"][t] = gt_extras_dict
                    raw_data["gt_visibility"][t] = np.empty(0).astype(float)  # added by ljp
                else:
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for t in range(raw_data["num_timesteps"]):
            ...
            gt_visibility = raw_data["gt_visibility"][t]
            ...
            data["gt_visibility"][t] = gt_visibility[gt_to_keep_mask]
